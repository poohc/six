                    ...
                    <table>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="bb_line1"><input type="text" class="input_type1"><button class="btn_type1">중복확인</button></td>
                            </tr>
                            <tr>
                                <th class="bb_line1"><span class="essential">닉네임</span></td>
                                <td class="bb_line1"><input type="text" class="input_type1"></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <th class="bb_line1"><span class="essential">비밀번호찾기</span></td>
                                <td class="bb_line1"><input type="text" class="input_type1"></td>
                            </tr>
                            <tr>
                                <th class="bb_line1"><span class="essential">이메일</span></td>
                                <td class="bb_line1"><input type="text" class="input_type1 type2">@<input type="text" class="input_type1 type3"><button class="btn_type1">중복확인</button></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td class="bg_type2"><input type="text" class="input_type1"></td>
                            </tr>
                            <tr>
                                <th class="bg_type2">생년월일</th>
                                <td class="bg_type2"><input type="text" class="input_type1 type4"> 년 <input type="text" class="input_type1 type5"> 월 <input type="text" class="input_type1 type5"> 일</td>
                            </tr>
                            <tr>
