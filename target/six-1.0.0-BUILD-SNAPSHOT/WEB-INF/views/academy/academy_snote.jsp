	...
	<div id="header">
        ...
        <div class="middle_header">
            <div class="middle_header2">
                <a href="#"><img src="../../img/logo.png" alt="six 주식정보거래소"></a>
                <div class="realtime">
                    <p class="realtime1"><img src="../../img/pang.png" alt=""> <span>실시간 증시일정</span></p>
                    <p class="realtime2">오늘은 선물옵션 만기일입니다.</p>
                </div>
            </div>
        </div>
		<div id="menuwrap">
			...
			<div id="navigation_pc">
				<ul id="navigation">
                    ...
                    <li><a href="" class="btnPullDown">증권가소식</a>
                        <!-- 2뎁스 시작 -->
	...
	<div id="wrap_container">
        <div class="container">
            <div class="wrap_left">
                ...
                <div class="about_six">
                    ...
                    <ul class="about_sixlist">
                        <li><a href="#">SIX 주식배움터<span></span></a></li>
                        <li><a href="#">SIX 투자전략<span></span></a></li>
                        <li class="on"><a href="#">SIX 탐방노트<span></span></a></li>
                        <li><a href="#">필수 구독자료<span></span></a></li>
                    </ul>
                </div>
                <div class="left_ad">
            ...
            <div class="wrap_right">
                <img src="../../img/academy1.jpg" alt="" class="top_mainimg">
                    ...
                    <div class="table_type1">
                        <table>
                            ...
                            <tbody>
                                <tr class="">
                                    <td>999</td>
                                    <td class="t_l"><a href="#" class="plus_img"><img src="../../img/academy_bul.jpg" alt=""><div class="acatitle_area"><p class="academy_title">SIX 주식 배움터</p><p class="academy_title2">집합투자증권을 취득하기 전에 투자대상, 환매방법, 보수 등에 관하여 (간이)투자설명서를 반드시 읽어 보시기 바랍니다.</p></div></a></td>
                                    <td>앨리스</td>
                                    <td>2015-09-20</td>
                                    <td>3125</td>
                                </tr>
