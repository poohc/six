	...
	<div id="wrap_container">
        <div class="container">
            <div class="wrap_left">
                ...
                <div class="about_six">
                    <p class="about_sixtitle">SIX일급정보</p>
                  	 <ul class="about_sixlist">
                        <li><a href="#">무료종목추천<span></span></a></li>
                        <li><a href="#">SIX비기<span></span></a></li>
                        <li><a href="#">실시간증시일정<span></span></a></li>
                        <li class="on"><a href="#">증시브리핑<span></span></a></li>
                        <li><a href="#">고수들의인터뷰<span></span></a></li>
                  	 </ul>
                </div>
                <div class="left_ad">
