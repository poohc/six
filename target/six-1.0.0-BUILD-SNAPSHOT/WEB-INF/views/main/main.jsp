	...
	<div id="wrap_container">
        <div class="container">
            ...
            <ul class="mainbanner_list">
                <li><a><p>SIX <br>아카데미</p><img src="/resources/img/mainbanner1.png" alt=""></a></li>
                <li><a><p>SIX <br>일급정보</p><img src="/resources/img/mainbanner2.png" alt=""></a></li>
                <li><a><p>특강 <br>세미나</p><img src="/resources/img/mainbanner3.png" alt=""></a></li>
            </ul>
            <ul class="look_ahead2">
                <li>
                    <p class="look_title"><span>SIX</span>주식 배움터</p>
                    <a class="look_more2"><img src="/resources/img/view_more2.png" alt="더보기"></a>
                    <div class="ahead_top">
